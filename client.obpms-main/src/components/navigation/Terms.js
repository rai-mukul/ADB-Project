  ...
  return (
    <div>
      <Container sx={{pt:2}}>
        ...
        <p>Welcome to obpms.in!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of OBPMS's Website, located at https://obpms.in.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use obpms.in if you do not agree to
        ...
        <p>
          ...
          compliant to the Company&rsquo;s terms and conditions. "The Company",
          "Ourselves", "We", "Our" and "Us", refers to our Company. "Party",
          "Parties", or "Us", refers to both the Client and ourselves. All terms
          refer to the offer, acceptance and consideration of payment necessary
          to undertake the process of our assistance to the Client in the most
          appropriate manner for the express purpose of meeting the
          Client&rsquo;s needs in respect of provision of the Company&rsquo;s
        ...
        <p>
          We employ the use of cookies. By accessing obpms.in, you agreed to use
          cookies in agreement with the OBPMS's Privacy Policy.
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, OBPMS and/or its licensors own the
          intellectual property rights for all material on obpms.in. All
          intellectual property rights are reserved. You may access this from
          obpms.in for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from obpms.in</li>
          <li>Sell, rent or sub-license material from obpms.in</li>
          <li>Reproduce, duplicate or copy material from obpms.in</li>
          <li>Redistribute content from obpms.in</li>
        </ul>
        <p>
        ...
        <p>
          ...
          OBPMS does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of OBPMS,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, OBPMS shall not be liable for
        ...
        <p>
          OBPMS reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant OBPMS a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of OBPMS; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to OBPMS. Please include your name, your
        ...
        <p>
          No use of OBPMS's logo or other artwork will be allowed for linking
