...
export default function Privacy() {
  return (
    <div>
      <Container sx={{pt:2}}>
        <Typography variant="h5">Privacy Policy for OBPMS</Typography>
        <p>
          At obpms.in, accessible from https://obpms.in, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by obpms.in and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in obpms.in. This policy is not applicable to
        ...
        <h2>Log Files</h2>
        <p>
          obpms.in follows a standard procedure of using log files. These files
        ...
        <p>
          ...
          advertising partners of obpms.in.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on obpms.in, which are sent
        ...
        <p>
          Note that obpms.in has no access to or control over these cookies that
          are used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          obpms.in's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          obpms.in does not knowingly collect any Personal Identifiable
